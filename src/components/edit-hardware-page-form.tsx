...
export default function EditHardwarePageForm({ hardware }: { hardware: z.infer<typeof formSchema> & { id: string }}) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      await updateDoc(hardwareRef, values);
      setUpdatedItemTitle(values.name);
      setShowSuccessDialog(true);
    } catch (error: any) {
      toast({
        variant: 'destructive',
        title: 'Error',
        description: error.message || 'Failed to update hardware.',
      });
    }
  }
      ...
      <AlertDialog open={showSuccessDialog} onOpenChange={setShowSuccessDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              The product "{updatedItemTitle}" has been successfully updated.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
